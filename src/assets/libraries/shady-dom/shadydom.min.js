...
function lb(){for(var a in ib)window.addEventListener(a,function(a){a.__target||(mb(a),kb(a),a.stopImmediatePropagation())},!0)}function mb(a){a.__target=a.target;a.H=a.relatedTarget;if(p.i){var b=Object.getPrototypeOf(a);if(!b.hasOwnProperty("__patchProto")){var d=Object.create(b);d.U=b;y(d,gb);b.__patchProto=d}a.__proto__=b.__patchProto}else y(a,gb)}var nb=hb(window.Event),ob=hb(window.CustomEvent),pb=hb(window.MouseEvent);function qb(a){var b=a.getRootNode();u(b)&&Ha(b);return a.__shady&&a.__shady.assignedSlot||null}
var rb={addEventListener:function(a,b,d){if(b&&"function"===typeof b){var c,e,h;"object"===typeof d?(c=!!d.capture,e=!!d.once,h=!!d.passive):(c=!!d,h=e=!1);if(b.a)for(var g=0;g<b.a.length;g++){if(b.a[g].node===this&&b.a[g].type===a&&b.a[g].capture===c&&b.a[g].once===e&&b.a[g].passive===h)return}else b.a=[];g=function(c){e&&this.removeEventListener(a,b,d);c.__target||mb(c);if(c.composed||-1<c.composedPath().indexOf(this))if(c.eventPhase===Event.BUBBLING_PHASE&&c.target===c.relatedTarget)c.stopImmediatePropagation();
else return b.call(this,c)};b.a.push({node:this,type:a,capture:c,once:e,passive:h,T:g});ib[a]?(this.b=this.b||{},this.b[a]=this.b[a]||{capture:[],bubble:[]},this.b[a][c?"capture":"bubble"].push(g)):T.addEventListener.call(this,a,g,d)}},removeEventListener:function(a,b,d){if(b){var c,e,h;"object"===typeof d?(c=!!d.capture,e=!!d.once,h=!!d.passive):(c=!!d,h=e=!1);var g=void 0;if(b.a)for(var f=0;f<b.a.length;f++)if(b.a[f].node===this&&b.a[f].type===a&&b.a[f].capture===c&&b.a[f].once===e&&b.a[f].passive===
h){g=b.a.splice(f,1)[0].T;b.a.length||(b.a=void 0);break}T.removeEventListener.call(this,a,g||b,d);g&&ib[a]&&this.b&&this.b[a]&&(a=this.b[a][c?"capture":"bubble"],g=a.indexOf(g),-1<g&&a.splice(g,1))}},appendChild:function(a){return Xa(this,a)},insertBefore:function(a,b){return Xa(this,a,b)},removeChild:function(a){if(a.parentNode!==this)throw Error("The node to be removed is not a child of this node: "+a);if(!Ma(a)){var b=u(this)?this.host:this,d=H.parentNode(a);b===d&&T.removeChild.call(b,a)}Pa(this,
null,a);return a},replaceChild:function(a,b){this.insertBefore(a,b);this.removeChild(b);return a},cloneNode:function(a){var b;if("template"==this.localName)b=T.cloneNode.call(this,a);else if(b=T.cloneNode.call(this,!1),a){a=this.childNodes;for(var d=0,c;d<a.length;d++)c=a[d].cloneNode(!0),b.appendChild(c)}return b},getRootNode:function(){return Ra(this)},get isConnected(){var a=this.ownerDocument;if(a&&a.contains&&a.contains(this)||(a=a.documentElement)&&a.contains&&a.contains(this))return!0;for(a=
this;a&&!(a instanceof Document);)a=a.parentNode||(a instanceof W?a.host:void 0);return!!(a&&a instanceof Document)}},sb={get assignedSlot(){return qb(this)}},tb={querySelector:function(a){return Va(this,function(b){return ca.call(b,a)},function(a){return!!a})[0]||null},querySelectorAll:function(a){return Va(this,function(b){return ca.call(b,a)})}},ub={assignedNodes:function(a){if("slot"===this.localName){var b=this.getRootNode();u(b)&&Ha(b);return this.__shady?(a&&a.flatten?this.__shady.h:this.__shady.assignedNodes)||
[]:[]}}},vb=da({setAttribute:function(a,b){Y||(Y=window.ShadyCSS&&window.ShadyCSS.ScopingShim);Y&&"class"===a?Y.setElementClass(this,b):(T.setAttribute.call(this,a,b),Ua(this,a))},removeAttribute:function(a){T.removeAttribute.call(this,a);Ua(this,a)},attachShadow:function(a){if(!this)throw"Must provide a host.";if(!a)throw"Not enough arguments.";return new W(Ga,this)},get slot(){return this.getAttribute("slot")},set slot(a){this.setAttribute("slot",a)},get assignedSlot(){return qb(this)}},tb,ub);
Object.defineProperties(vb,qa);var wb=da({importNode:function(a,b){return Ya(a,b)}},tb);Object.defineProperties(wb,{_activeElement:P.activeElement});function Z(a,b){for(var d=Object.getOwnPropertyNames(b),c=0;c<d.length;c++){var e=d[c],h=Object.getOwnPropertyDescriptor(b,e);h.value?a[e]=h.value:Object.defineProperty(a,e,h)}};p.J&&(window.ShadyDOM={inUse:p.J,patch:function(a){return a},isShadyRoot:u,enqueue:ha,flush:E,settings:p,filterMutations:cb,observeChildren:ab,unobserveChildren:bb,nativeMethods:T,nativeTree:H},window.Event=nb,window.CustomEvent=ob,window.MouseEvent=pb,lb(),Z(window.Node.prototype,rb),Z(window.Text.prototype,sb),Z(window.DocumentFragment.prototype,tb),Z(window.Element.prototype,vb),Z(window.Document.prototype,wb),window.HTMLSlotElement&&Z(window.HTMLSlotElement.prototype,ub),p.i&&(R(window.Node.prototype),
